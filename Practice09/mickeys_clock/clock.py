...
class MickeyClock:
    def __init__(self, screen_width, screen_height):
        ...
        self.bg = pygame.image.load(os.path.join(img_dir, "main-clock.png"))
        self.bg = pygame.transform.scale(self.bg, self.screen_size)
        
        self.mickey_body = pygame.image.load(os.path.join(img_dir, "mickey-full-body.png")).convert_alpha()
        ...
        self.min_hand_orig = pygame.image.load(os.path.join(img_dir, "right-hand.png")).convert_alpha()
        self.min_hand_orig = pygame.transform.scale(self.min_hand_orig, (200, 300)) 
        
        self.sec_hand_orig = pygame.image.load(os.path.join(img_dir, "left-hand.png")).convert_alpha()
